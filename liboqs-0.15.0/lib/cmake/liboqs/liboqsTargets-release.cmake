...
set_target_properties(OQS::oqs PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liboqs.0.15.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liboqs.9.dylib"
  )

list(APPEND _cmake_import_check_targets OQS::oqs )
list(APPEND _cmake_import_check_files_for_OQS::oqs "${_IMPORT_PREFIX}/lib/liboqs.0.15.0.dylib" )
